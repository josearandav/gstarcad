...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:void(0)" onclick="index.loadContent('app/addApp')" class="btn btn-primary radius">
                <i class="Hui-iconfont">&#xe600;</i> 添加应用</a>
        </span>
    </div>
...
<script src="/resource/js/console/app/appManage.js"></script>
