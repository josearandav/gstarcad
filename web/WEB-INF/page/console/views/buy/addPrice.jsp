...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                    <input type="text" class="input-text"  id="price" placeholder="请输入数字,新的购买价格">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">促销-原价：</label>
            <div class="formControls col-xs-6 col-sm-6">
                    <input type="text" class="input-text"  id="formerprice" placeholder="请输入数字，原来的购买价格">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">购买-URL：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text"  id="buyURL" placeholder="请输入完整的URL">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">升级-价格：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text"  id="nowupdatePrice" placeholder="请输入数字，新的升级价格">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">升级促销-原价：</label>
            <div class="formControls col-xs-6 col-sm-6">
                    <input type="text" class="input-text"  id="updatePrice" placeholder="请输入数字，原来的升级价格">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">升级-URL：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text"  id="updateURL" placeholder="请输入完整的URL">
            </div>
        </div>
        <div class="row cl">
